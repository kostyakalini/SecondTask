...
public class CharacterResolverTest {
    CharacterResolver characterResolver = new CharacterResolver();
    ...
    public void testReplaceWordsNormal(){
        ...
        //when
        String actual = characterResolver.replaceWords(stringBefore, substring);
        //then
    ...
    public void testReplaceWordsWithExtraSpaces(){
        //given
        SimpleString stringBefore = new SimpleString(" 34qx 1  c34c 34c ttt ccc ");
        String substring = "sub";
        //when
        String actual = characterResolver.replaceWords(stringBefore, substring);
        //then
        Assert.assertEquals(" 34qx 1  c34c 34c sub sub ", actual);
    }
    ...
    public void testReplaceLettersNormal(){
        ...
        char substring = '3';
        //when
        String actual = characterResolver.replaceLetters(stringBefore, order, substring);
        //then
